...
const demoRx = [
  { id: "rx1", patientId: "p3", patient: "Amit Verma", date: "Today · 09:25", items: ["Pantoprazole 40 mg — once daily", "Antacid PRN"], status: "active" },
  { id: "rx2", patientId: "p1", patient: "Ravi Kumar", date: "Aug 28", items: ["Aspirin 75 mg — once daily", "Atorvastatin 10 mg — nightly"], status: "active" },
  { id: "rx3", patientId: "p6", patient: "Rahul Sharma", date: "Aug 20", items: ["Amlodipine 5 mg — once daily"], status: "active" },
];
        ...
        {demoRx.map((r, i) => (
          <motion.div key={r.id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
            ...
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => openPatient(r.patientId)} className="flex items-center gap-1 text-xs font-medium text-primary">View <Download className="size-3.5" /></button>
            </div>
