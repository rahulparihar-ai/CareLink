  ...
  const sections: HistorySection[] = [
    {
      ...
      content: (
        <div className="space-y-2 text-sm">
          ...
          <p><span className="text-muted-foreground">Age/Sex:</span> 34 · Male</p>
          <p><span className="text-muted-foreground">Blood group:</span> B+</p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-2">
          <ConditionTag label="Hypertension" note="Diagnosed 2023 · Active" tone="warn" />
          <ConditionTag label="Dyslipidemia" note="Monitoring" tone="info" />
        </div>
      ),
    },
    {
