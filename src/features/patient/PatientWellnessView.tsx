...
export function PatientWellnessView() {
  ...
  const items = [
    { icon: Footprints, title: "Steps", sub: "Track your daily activity", bg: "bg-emerald-500/10 text-emerald-600", metric: stepsData.today.toLocaleString(), metricLabel: "steps today", view: "PATIENT_STEPS" as const },
    { icon: Moon, title: "Sleep", sub: "Understand your rest", bg: "bg-sky-500/10 text-sky-600", metric: `${sleepData.todayHours}h`, metricLabel: "last night", view: "PATIENT_SLEEP" as const },
