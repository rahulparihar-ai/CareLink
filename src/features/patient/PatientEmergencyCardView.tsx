        ...
        <div className="space-y-3 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-bold">{p?.bloodGroup ?? "B+"}</p>
            </div>
          </div>

          <EmergencyRow icon={AlertTriangle} tone="danger" label="Critical Allergies" value={p?.allergies ?? "Penicillin"} />

          <EmergencyRow icon={HeartPulse} tone="warn" label="Critical Conditions" value={p?.knownConditions ?? "Hypertension"} />

          <EmergencyRow icon={Pill} tone="info" label="Important Medication" value={p?.currentMedicines ?? "Amlodipine 5mg"} />
