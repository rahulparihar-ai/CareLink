...
export function ScanPrescriptionView() {
  ...
  const startScan = async () => {
    ...
    setLoading(false);
    setFields([
      { label: "Patient Name", value: patientProfile?.name ?? "Rahul Sharma" },
      { label: "Date", value: "Aug 31, 2026" },
      { label: "Doctor", value: "Dr. Arjun Mehta" },
      { label: "Medicine 1", value: "Amlodipine 5 mg — Once daily" },
      { label: "Medicine 2", value: "Metformin 500 mg — Twice daily" },
      { label: "Instructions", value: "Follow-up in 3 months. Monitor BP regularly." },
    ]);
    setPhase("review");
  };
