...
const followups = [
  { id: "f1", patient: "Sunita Devi", reason: "Echo + dyspnea review", date: "Sep 06, 2026", status: "scheduled" },
  { id: "f2", patient: "Kiran Patel", reason: "Diabetic neuropathy review", date: "Sep 12, 2026", status: "scheduled" },
  { id: "f3", patient: "Ravi Kumar", reason: "Cardiology referral follow-up", date: "Sep 03, 2026", status: "pending" },
  { id: "f4", patient: "Rahul Sharma", reason: "HbA1c + BP review", date: "Sep 20, 2026", status: "completed" },
];
      ...
      <div className="space-y-2.5">
        {followups.map((f, i) => (
          <motion.button key={f.id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
            whileTap={{ scale: 0.99 }} onClick={() => { setSelectedPatientId("p" + (i < 3 ? (i + 2) : 6)); setView("DOCTOR_PATIENT"); }}
